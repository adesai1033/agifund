...
# STAGE 1
def generate_reasoning_modules(task_description, system_prompt, user_prompt):
    """
    Step 1: GENERATE reasoning modules for the task.
    """
    prompt = f"Given {system_prompt} accompanied with {user_prompt}, 
    reasoning_modules = query_openai(prompt)
